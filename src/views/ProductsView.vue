<template>
  <main class="pt-8 sm:pt-28 pb-10">
    ...
    >
      <h1 class="text-lg sm:text-3xl text-slate-700 font-semibold">Product</h1>
    ...
    <div>
      <ProductList :products="products.data" @edit="onEdit" @delete="onDelete" />
      <div class="mt-3">
        <Paginator :rows="5" :totalRecords="products.meta.total" @page="onNextPage"></Paginator>
      </div>
    </div>
  </main>
</template>
...
const fetchProducts = async () => {
  await getProducts(4, currentPage.value, searchSubmit.value)
}
